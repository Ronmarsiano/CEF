...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|rt=$common=event-formatformatted-receive_time deviceExternalId=0002D01655 dpt=443 src=1.1.1.1 dst=4.4.4.4 sourceTranslatedAddress=1.1.1.1 destinationTranslatedAddress=3.3.3.3 msg=Account has been deleted AccountFullName=Harley.Quinn DisplayName=HarleenFrances Quinzel"

...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0002D01655 dpt=49510 suid=john@contoso77.com suser=john@contoso77.com proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=192.168.0.1 dst=164.121.0.4 sourceTranslatedAddress=1.1.1.1 destinationTranslatedAddress=3.3.3.3 testIndex="

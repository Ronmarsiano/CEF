...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0001A01234 dpt=49510 suid=EobardThawne@contoso77.com suser=EobardThawne@contoso77.com dst=204.12.0.3 proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=204.128.0.2 sourceTranslatedAddress=211.0.17.10 destinationTranslatedAddress=3.4.6.3 testIndex="

...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0001A01234 dpt=49510 suid=speedygonzales@contoso77.com suser=speedygonzales@contoso77.com proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=203.108.0.1 dst=232.106.0.1 sourceTranslatedAddress=205.148.0.1 destinationTranslatedAddress=3.4.3.3 testIndex="

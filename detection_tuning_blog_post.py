...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0001A01234 dpt=49510 suid=simonL@contoso77.com suser=simonL@contoso77.com proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=121.108.2.1 dst=131.166.2.1 sourceTranslatedAddress=155.108.2.1 destinationTranslatedAddress=3.4.3.3 testIndex="

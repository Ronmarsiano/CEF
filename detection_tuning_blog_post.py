...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0001A01234 dpt=49510 suid=BillyBatson@contoso77.com suser=BillyBatson@contoso77.com proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=203.15.0.3 dst=227.132.0.1 sourceTranslatedAddress=211.138.0.1 destinationTranslatedAddress=3.4.6.3 testIndex="

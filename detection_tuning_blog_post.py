...
fixed_message_p2 = "|PAN-OS|common=event-format-test|end|TRAFFIC|1|deviceExternalId=0001A01234 dpt=49510 suid=BarryAllen@contoso77.com suser=BarryAllen@contoso77.com dst=303.14.0.6 src=204.128.0.2  proto=TCP dvchost=PaloAltoDevice app=incomplete reason=tcp-rst-from-server act=ack src=204.128.0.2 sourceTranslatedAddress=211.0.17.10 destinationTranslatedAddress=3.4.6.3 testIndex="
...
def stream_message(ip, port, message_per_second, time_in_second, message_to_send, is_cef, rfc_5424):
    for curr_second in range(0, int(time_in_second)):
        ...
        message_to_send = message_per_second + " rand=" + str(rand_int)
